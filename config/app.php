...
return [
    ...
    'metadata_base_url' => env('APP_URL', "{$required['APP_PROTOCOL']}://{$required['APP_NAME']}.{$required['APP_DOMAIN']}"),
    'auth_base_url' => env('APP_URL', "{$required['APP_PROTOCOL']}://auth.{$required['APP_DOMAIN']}"),
];
